...
#create a publisher
pub = rospy.Publisher('publish_odom_filtered_pose',pose_msg, queue_size =10)
...
def main():
	#initialize node
	rospy.init_node("publish_odom_filtered_pose", anonymous=True)
...
if __name__ == '__main__':
	...
	print("starting publishing filtered pose...")
	main()
